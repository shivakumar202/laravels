<!--begin::Logo-->
<div class="app-sidebar-logo px-6 bg-info justify-content-start" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="{{ route('dashboard') }}" class="text-white">
		<h1 class="app-sidebar-logo-default ">MCM SOLUTIONS</a>
		<img alt="Logo" src="{{ asset('assets/media/logos/alphabet.png')}}" class="h-20px app-sidebar-logo-minimize" />
